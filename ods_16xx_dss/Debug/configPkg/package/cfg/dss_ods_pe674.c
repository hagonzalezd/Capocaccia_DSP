...
/* --> OdsDemo_sleep */
extern xdc_Void OdsDemo_sleep(xdc_Void);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/hgonzalezdiaz/workspace_v8/ods_16xx_dss/Debug/configPkg/package/cfg/dss_ods_pe674");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[3] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)OdsDemo_sleep)),  /* [0] */
